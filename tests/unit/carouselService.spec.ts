import { createCarousel } from "../../src/carouselService";
...
describe('createCarousel', () => {
  it('hit many shops', () => {
    ...
    const actual = createCarousel(mockRest);
